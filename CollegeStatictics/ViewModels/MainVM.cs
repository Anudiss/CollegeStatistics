    ...
    public partial class MainVM : WindowViewModelBase
    {
        public static readonly Dictionary<string, Func<IContent>> PageBuilders = new()
        {
            ...
            { "Занятия", () => new ItemsContainerBuilder<Lesson, LessonView>()
                                   ...
                                   .AddCheckBoxColumn($"{nameof(LessonView.IsConducted)}", "Проведено")
            ...
            { "Остаток по часам", () => new ReportBuilder<Lesson>()
                                    ...
                                    .AddSelection(new Selection<Lesson>(lesson => lesson.IsConducted))
            ...
            { "Отчёт успеваемости", () => new ReportBuilder<Attendance>()
                                    .SetTitle("Успеваемости студентов")
                                    ...
                                    .AddSelection(new Selection<Attendance>(attendance => attendance?.Lesson?.IsConducted == true))
